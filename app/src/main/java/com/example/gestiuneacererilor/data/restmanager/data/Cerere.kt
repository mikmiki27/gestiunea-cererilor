...
class Cerere {
    ...
    constructor (id: String, student_solicitant: String, id_student: String, email_student_solicitat: String, facultate_student: String, profesor_solicitat: String, email_profesor_solicitat: String, id_profesor: String, status: String, tip_cerere: String, raspuns: String, mentiuni: String) {
        this.id = id
    ...
    constructor (student_solicitant: String, id_student: String, email_student_solicitat: String, facultate_student: String, profesor_solicitat: String, email_profesor_solicitat: String, id_profesor: String, status: String, tip_cerere: String, mentiuni: String) {
        this.student_solicitant = student_solicitant
        this.id_student = id_student
        this.email_student_solicitat = email_student_solicitat
        this.facultate_student = facultate_student
